---
title: "Tutorial 9 - National Ozone Time Series"
author: "SFR 605"
output: html_document
---

The objective of this week's tutorial is to familiarize yourself with the tools and techniques to do exploratory analyses for time series analysis and to fit a basic Bayesian AR(1) model.
...
The Ozone.Rdata file contains a data table, *ozone*, which contains nationally averaged ozone data for 1980-2008.  This data is expressed in terms of the 4th Maximum 8-Hour Average (ppb), which is an odd statistic but one relevant to regulatory criteria.
